        ...
        message(newVal){
            ...
            this.axios.get('/api/searchList?cityId=10&kw='+newVal,{
                ...
                if(this.axios.isCancel(err)) {
                    console.log('Reauest canceled', err.message);
                } else{
                    console.log(err);
                }
            });
...
.search_body .search_input .search_input_box{ padding: 0 10px; border: 1px solid #e6e6e6; border-radius: 5px; background-color: #fff; display: flex;line-height: 20px;}
.search_body .search_input i{font-size: 16px; padding: 4px 0;}
.search_body .search_input input{ border: none; font-size: 13px; color: #333; padding: 4px 0; outline: none; margin-left: 5px; width: 100%;}
